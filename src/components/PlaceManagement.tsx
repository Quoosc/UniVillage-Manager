...
const initialPlaces: Place[] = [
  ...
  { id: 'P002', name: 'Tiệm Photo Tuấn', address: '45 Đường Lý Thường Kiệt, Khu A', thumbnail: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=400&h=300&fit=crop', category: 'Tiện ích', area: 'Khu A', status: 'Pending', rating: 0, proposer: { name: 'Phạm Trấn Quốc', avatar: 'https://i.pravatar.cc/150?u=11', role: 'Chủ cửa hàng' } },
  { id: 'P003', name: 'Quán Cà Phê Guitar Mộc', address: '78 Đường Vành Đai, KTX Khu B', thumbnail: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&h=300&fit=crop', category: 'Cà phê', area: 'Khu B', status: 'Pending', rating: 0, proposer: { name: 'Hồ Ngọc Quỳnh', avatar: 'https://i.pravatar.cc/150?u=12', role: 'Sinh viên' } },
  { id: 'P004', name: 'Cơm Tấm Kiều Giang', address: 'Cổng chính KTX Khu A', thumbnail: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&h=300&fit=crop', category: 'Ăn uống', area: 'Khu A', status: 'Open', rating: 4.5, proposer: { name: 'Võ Sĩ Trí Thông', avatar: 'https://i.pravatar.cc/150?u=admin', role: 'Admin' } },
  { id: 'P005', name: 'Nhà Văn Hóa Sinh Viên', address: 'Quảng trường sáng tạo', thumbnail: 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=400&h=300&fit=crop', category: 'Tiện ích', area: 'Trung tâm', status: 'Open', rating: 4.8, proposer: { name: 'Nguyễn Minh Đức', avatar: 'https://i.pravatar.cc/150?u=admin', role: 'Admin' } },
];
